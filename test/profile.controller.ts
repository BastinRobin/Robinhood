...
describe('Profile', () => {
  ...
  it('should get an profile by id', () =>
    request(Server)
      .get(`/v1/profile/${id}`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
      .expect('Content-Type', /json/)
  ...
  it('should not get an profile when id is null', () =>
    request(Server)
      .get(`/v1/profile/null`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
      .expect('Content-Type', /json/)
  ...
  it('should not get an profile when url not found', () =>
    request(Server)
      .get(`/v1/profiles/`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
  ...
  it('should not delete profile when id is null', () =>
    request(Server)
      .delete(`/v1/profile/null`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
      .expect('Content-Type', /json/)
      .then((r) => {
        expect(r.body).equal(
