...
describe('branch', () => {
  ...
  it('should not get an branch when id is null', () =>
    request(Server)
      .get(`/v1/branch/null`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
      .expect('Content-Type', /json/)
  ...
  it('should not get an branch when url not found', () =>
    request(Server)
      .get(`/v1/branchs/`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
  ...
  it('should not delete branch when id is null', () =>
    request(Server)
      .delete(`/v1/branch/null`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
      .expect('Content-Type', /json/)
      .then((r) => {
        expect(r.body).equal(
