...
describe('role', () => {
  ...
  it('should not get an role when id is null', () =>
    request(Server)
      .get(`/v1/role/null`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
      .expect('Content-Type', /json/)
  ...
  it('should not get an role when url not found', () =>
    request(Server)
      .get(`/v1/roles/`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
  ...
  it('should not delete role when id is null', () =>
    request(Server)
      .delete(`/v1/role/null`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
      .expect('Content-Type', /json/)
