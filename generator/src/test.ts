...
describe('Examples', () => {
  ...
  it('should not get an example when id is null', () =>
    request(Server)
      .get(`/v1/example/null`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
      .expect('Content-Type', /json/)
  ...
  it('should not get an example when url not found', () =>
    request(Server)
      .get(`/v1/examples/`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
  ...
  it('should not delete example when id is null', () =>
    request(Server)
      .delete(`/v1/example/null`)
      .set({ token: process.env.UNIT_TESTING_AUTH_TOKEN })
      .expect('Content-Type', /json/)
      .then((r) => {
        expect(r.body).equal(
